...
export const CLIENT_SLASH_COMMANDS = new Set([
  'clear',
  'new',
  'restart',
  'sessions',
...
export function countConfiguredProviderValues(
...
export async function normalizeWorkspaceAdditionalDirectories(
  input: string[],
...
export async function buildStartupPrompt(
  workspaceRoot?: string,
  systemPrompt?: string
): Promise<string> {
...
// Re-export path utilities used directly by the router
export {
  buildAdditionalDirectoryPathPolicy,
  buildWorkspaceAttachmentPathPolicy,
  canonicalizeRoots,
