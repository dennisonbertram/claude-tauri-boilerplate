# STORY-117: Artifact Search and Filter by Project
...
|-------|-------|
| Story | STORY-117 |
| Title | Artifact Search and Filter by Project |
...
**BLOCKED** -- This story requires workspace context to access artifact management features.
