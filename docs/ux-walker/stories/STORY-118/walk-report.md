# STORY-118: Code Review Severity Breakdown
...
|-------|-------|
| Story | STORY-118 |
| Title | Code Review Severity Breakdown |
...
**BLOCKED** -- This story requires workspace context to access code review features.
