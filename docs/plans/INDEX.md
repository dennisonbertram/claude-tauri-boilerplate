...
| [issues-78-83-84-91-110-117-wave8-completion.md](issues-78-83-84-91-110-117-wave8-completion.md) | Completion wave plan for finishing the still-open wave-7 issues, including fresh worktrees, tmux-backed subagents, integration branch flow, and final GitHub closeout criteria. |
